...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if not users.exists() or len(degrees) == 0 or len(fields_of_study) == 0:
            self.stdout.write(self.style.ERROR('Please ensure there are Users, Degrees, and Fields of Study in the database.'))
            return
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully created {num_degrees} fake Degrees and {num_fields} fake Fields of Study.'))
