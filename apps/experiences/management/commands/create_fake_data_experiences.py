...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for _ in range(num_experiences):
            ...
            experience.skills_used.set(fake.random_elements(elements=skills, length=3))  # Assign random skills

        self.stdout.write(self.style.SUCCESS(f'Successfully created {num_experiences} fake Experiences.'))
