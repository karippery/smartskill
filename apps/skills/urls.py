...
urlpatterns = [
    path(
        "skills-categories/",
        SkillCategoryListCreateView.as_view(),
        name="skill-category-list-create",
    ),
    path(
        "skills-categories/<int:pk>/",
        SkillCategoryDetailView.as_view(),
    ...
    path(
        "user-skills/",
        UserSkillsListCreateView.as_view(),
        name="user-skills-list-create",
    ),
    path(
        "user-skills/<int:pk>/",
        UserSkillsDetailView.as_view(),
        name="user-skills-detail",
    ),
]
